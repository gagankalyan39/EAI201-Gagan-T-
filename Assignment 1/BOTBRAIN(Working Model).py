...
campus_graph = {
    ...
    'Food Court': [('Academic Block 2', 240, 1.0), ('Cricket Ground', 40, 1.0), ('Hostel Building 1', 120, 1.0)],
    # Hostel to Security Gate because everyone must exit from there.
    'Hostel Building 1': [('Hostel Building 2', 240, 1.0), ('Food Court', 120, 1.0), ('Security Gate', 400, 1.0)],
    'Cricket Ground': [('Food Court', 40, 1.0)]
}

# Co-ordinates for our A* search. This helps it find a good path quickly.
# It's like a mental map of the campus.
building_coords = {
    'Entry Gate': (0, 180),
    'Exit Gate': (360, 180),
    'Security Gate': (180, 0),
...
# 3. QUERY PROCESSING AND INFORMATION SERVICES


def show_path(path, distance):
    """Displays the found path and its details. We'll show the way, step by step."""
    if path:
        print("\n--- Route Found! ---")
...
def run_query_loop():
    """Main loop for the user. Yeh hi hamara main program hai."""
    while True:
...
if __name__ == "__main__":
    ...
    print("=====================================================")
    print("This campus navigation bot helps you find the quickest path.")
    print("-----------------------------------------------------")
    while True:
